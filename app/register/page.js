...
export default function RegisterPage() {
  ...
  const { register, login } = useAuth(); // Get register and login from AuthContext
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userData = {
        ...
        dateOfBirth: 'Please update your date of birth',
        avatar: null,
      ...
      // Note: The actual redirect happens inside the register() function in AuthContext
